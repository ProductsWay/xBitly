...
export default function Footer() {
    return (
        <footer className="items-center p-4 mt-4 btm-nav footer bg-neutral text-neutral-content">
            ...
            <div className="grid-flow-col md:justify-self-end md:place-self-center">
                <a
